...
```{r bankkrav, echo=FALSE, result=TRUE,fig.height=3,fig.cap=("Kreditor (banken) har en fordring på skyldneren (kunden), fordringen betales tilbage med afdrag og renter")}

nodes <- data.frame(id = 1:2, shape = c("box"),label  = c("Skyldner\nKunde","Kreditor\nBank"),font.size = c(25,25))
