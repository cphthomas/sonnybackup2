...
```{r echo=FALSE}
text_tbl <- data.frame(
  Paragraf = c("Tilblivelsesmangler", "Indholdsmangler", "Habilitetsmangler"),
  Indhold = c(
    "Ugyldighed pga. omstændigheder ved aftalens indgåelse (tilblivelse), fx: \n
...
kable(collapse_rows_dt, align = "l") %>%
  kable_styling(full_width = T,bootstrap_options = c( "hover","responsive")) %>%
