...
```{r echo=FALSE}
# nodes <- data.frame(id = 1:3, group = c("A", "B", "C"),label = c(" Kautionist "," Bank "," Debitor "))
# edges <- data.frame(from = c(1,2,3), 
#                     to = c(2,3,1),
#                     arrows = c("to"),
#                     length = c(800,800,400),
#                     label=c("Kautionsaftale","Lån","100% anparter"),
#                     smooth = TRUE
#                     )
#  visNetwork(nodes, edges,main = "Ejers kaution for virksomhed") %>%
#  visGroups(groupname = "A", shape = "icon", 
#            icon = list(code = "f56c", size = 100, color = "blue",highlight = "yellow")) %>%
#  visGroups(groupname = "B", shape = "icon", 
#            icon = list(code = "f2bb", size = 150, color = "red",highlight = "yellow")) %>%
#    visGroups(groupname = "C", shape = "icon", 
#            icon = list(code = "f19c", size = 150, color = "red",highlight = "yellow")) %>%
#  addFontAwesome() %>%
#  
#  visEdges(shadow = TRUE,
#            arrows =list(to = list(enabled = TRUE, scaleFactor = 2)),
...
nodes <- data.frame(id = 1:4, 
                    shape = c("image"),
                    image = c("https://jura.tepedu.dk/img/insol1.jpg",
                    "https://jura.tepedu.dk/img/insol1.jpg",
                    "https://jura.tepedu.dk/img/uni.svg",
                    "https://jura.tepedu.dk/uni.svg"),
                    label = c("Bla bla bla","2","3","4"))
...
```{r echo=FALSE}
path_to_images <- "/Users/thomaspetersen/Google\ Drev/JURA/jurars/img/"
 
nodes <- data.frame(id = 1:4, 
                    shape = c("image"),
                    image = c("/Users/thomaspetersen/Google Drev/JURA/jurars/img/1.png",
                    "/Users/thomaspetersen/Google Drev/JURA/jurars/img/bank.png",
                    "/Users/thomaspetersen/Google Drev/JURA/jurars/img/uni.svg",
                    "/Users/thomaspetersen/Google Drev/JURA/jurars/img/4.png"),
                    label = c("Bla bla bla","2","3","4"))
