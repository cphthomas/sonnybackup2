...
edges <- data.frame(from = c(1), 
 ...
 visGroups(groupname = "A", shape = "icon", 
           icon = list(code = "f007", size = 200)) %>%
 visGroups(groupname = "B", shape = "icon", 
           icon = list(code = "f007", size = 200, color = "red",highlight = "yellow")) %>%
 addFontAwesome() %>%
...
edges <- data.frame(from = c(1), 
 ...
 visGroups(groupname = "A", shape = "icon", 
           icon = list(code = "f007", size = 200, color = "red")) %>%
 visGroups(groupname = "B", shape = "icon", 
           icon = list(code = "f007", size = 200, color = "black")) %>%
 addFontAwesome() %>%
...
<iframe src="https://cphthomas.shinyapps.io/shinytest/" width="800" height="900" style="border: none;"></iframe>
