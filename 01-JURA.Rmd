...
pacman::p_load(timeDate, DT,plotly,rio,exams,e1071,WriteXLS,maps,knitr,kableExtra,ggplot2,openxlsx,quantmod,highcharter,forecast,networkD3,DiagrammeR) #load various packages
```
...
```{r  figurretter,echo=FALSE, result=TRUE, fig.width=12,fig.height=3 ,dev='png'}
mermaid("
graph TD

A[Byrettens afdelinger]
B[Civilretten]
C[Fogedretten]
D[Skifteretten]
E[Boligretten]
...
classDef fedrød fill:#ff1a1a,stroke:#333,stroke-width:4px;
classDef fedlime fill:lime,stroke:#333,stroke-width:4px;
classDef fedlilla fill:#f9f,stroke:#333,stroke-width:4px;
class A,B,C,D,E,F fedlilla;
")
```

```{r  figurretter2,echo=FALSE, result=TRUE, fig.width=12,fig.height=3 ,dev='svg'}
mermaid("
graph TD
...
```{r  figurretter3,echo=FALSE, result=TRUE,dev='svg'}
mermaid("
graph TD
...
```{r  figurretter4,echo=FALSE, result=FALSE}
mermaid("
graph TD

A[Byrettens afdelinger figurretter3,echo=FALSE, result=FALSE]
B[Civilretten]
C[Fogedretten]
D[Skifteretten]
E[Boligretten]
...
```{r  figurretter6,echo=FALSE, result=TRUE}
mermaid("
graph TD
...
kable(text_tbl) %>%
  ...
  column_spec(2, width = "30em", background = "grey",color ="white")
```
...
A[Forhandlingsprincippet <br />æøå ret <br />Masser af tekst]
B[hello word]
C[C i firkant]
D[Forhandlingsprincippet]
E[Forhandlingsprincippet]
F>Forhandlingsprincippet]
G>Forhandlingsprincippet]
...
classDef fedrød fill:#ff1a1a,stroke:#333,stroke-width:4px;
classDef fedlime fill:lime,stroke:#333,stroke-width:4px;
classDef fedlilla fill:#f9f,stroke:#333,stroke-width:0px;
class D,E fedlilla;
class A fedrød;
class B fedlime;
")
...
## Quiz  
<h3><a href="https://quiz.tepedu.dk/juraaftale" target="_blank">Quiz Aftaleret</a></h3>
...
<div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://vimeo.com/album/5798044/embed" allowfullscreen frameborder="0" style="position:absolute;top:0;left:0;width:100%;height:100%;"></iframe></div>



  <iframe src="https://player.vimeo.com/video/320341517" width="640" height="55" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
  <br>
  <style>.embed-container { position: relative; padding-bottom: 56.25%; height: 55; overflow: hidden; max-width: 100%; } .embed-container iframe, .embed-container object, .embed-container embed { position: absolute; top: 0; left: 0; width: 100%; height: 100%; }</style><div class='embed-container'><iframe src='https://vimeo.com/album/5798044/embed' frameborder='0' webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></div>
  <br>
  <iframe src="https://player.vimeo.com/video/320339623" width="640" height="360" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
