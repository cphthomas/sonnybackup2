...
<!-- ![](img/alm.png) -->
<!-- (Kilde; Trojka) Figur 14.1. -->

**Banklån**
```{r almbank, echo=FALSE, result=TRUE,fig.cap=("Almindeligt banklån, kreditaftale om et lån indgået mellem en bank og en kunde")}
...
<!-- ![](img/kre.png) -->
<!-- (KIlde; Trojka) Figur 14.2. -->

**Kreditkøb**
```{r kredit, echo=FALSE, result=TRUE,fig.cap=("Kreditkøb, to parter i et kreditkøb")}
