...
Der er desuden mulighed for omstødelse iht. konkursloven. Modsat: individualforfølgning.
...
"Utilbørlige dispositioner"
  ...
  S3 = c(
    "Hvis debitor er insolvent på tidspunktet for handlingens foretagelse, og handlingen er til fordel for en nærtstående, er fristen (regnet tilbage fra fristdagen):",
"2 år",
"2 år",
"2 år",
"2 år",
...
```{r, echo=FALSE, result=TRUE ,fig.height=2.7,fig.cap=("Omstødelsesperiode for gaver")}
library(timevis)

data <- data.frame(
  id      = 1:5,
  content = c("6 måneder fra 2019-08-02 til 2020-02-01", "Omstødelsesperiode<br>starter<br>2019-08-02",
              "Overdragelse<br>af gave<br>2019-11-01", "Fristdag<br>2019-08-01","Konkursdekret<br>2019-08-22"),
  start   = c("2019-08-02", "2019-08-02",
              "2019-11-01", "2020-02-01","2020-02-25"),
  end     = c("2020-02-01", NA, NA, NA,NA) )
timevis(data)%>%
...
```{r, echo=FALSE, result=TRUE ,fig.height=2,fig.cap=("Modregning før fristdag")}
library(timevis)
...
```{r, echo=FALSE, result=TRUE ,fig.height=2,fig.cap=("Modregning mellem fristdag og konkursdekret")}
library(timevis)
...
```{r, echo=FALSE, result=TRUE ,fig.height=2.5,fig.cap=("Modregning mellem fristdag og konkursdekret")}
library(timevis)
