...
```{r, echo=FALSE, result=TRUE ,fig.cap=("Omstødelsesperiode for gaver")}
library(timevis)
...
```{r, echo=FALSE, result=TRUE ,fig.cap=("Modregning før fristdag")}
library(timevis)
...
```{r, echo=FALSE, result=TRUE ,fig.cap=("Modregning mellem fristdag og konkursdekret")}
library(timevis)
