...
![](img/kau1.png)
(KIlde; Trojka) Fig. 15.1.
**Parter i kautionsforhold**
```{r, echo=FALSE, result=TRUE,fig.cap=("Forholdet mellem debitor, kreditor og kautionist")}
...
![](img/kau2.png)
(Kilde; Trojka) fig. 15.4.

```{r kaution, echo=FALSE}

mydf <- data.frame(
  S1 = c(
"",
"Kautionisten ejer en del af den virksomhed, der kautioneres for bestemmende indflydelse er afgørende" ,
...
"Ejerandel under 10%" 
  ...
  S2 = c(
    "Privat kaution",
"Ejer kautionisten mindre end 50% af virksomheden, er det som udgangspunkt privat kaution.",
"Ubetydelig stilling uden indflydelse på driften, så er det stadig en privat kaution.", 
"Ingen indsigt i virksomhedens økonomi taler for en privat kaution.",
"Er ejerandelen lille i forhold til andres
ejerandel, er der ikke tale om bestemmende indflydelse, og kautionen er privat.
"
),
  S3 = c(
    "Erhvervskaution",
"Ejer kautionisten mere end 50 % af virksomheden, er det erhvervskaution.", 
"Har kautionisten en ledende stilling i virksomheden, kan det være en erhvervskaution, selvom kautionisten ejer mindre end 50% af virksomheden.",
"Har kautionisten stor indsigt i virksomhedens økonomi, kan det være en erhvervskaution selvom ejerandelen er under 50%",
"")
...
![](img/kau6.png)
(Kilde: Trojka) fig. 15.7.

**Kautionistens regresret**
```{r ,echo=FALSE, result=TRUE, fig.cap=("Kautionistens regresret over for låntager")}

nodes <- data.frame(id = 1:5, 
                    shape = c("box"), 
                    level = c(1,2,3,4,5),
                    label = c("1. Kreditor har krav på låntager","2. Låntager misligholder","3. Kreditor kræver kautionen indfriet ","4. Kautionisten betaler kreditor","5. Kautionisten har krav på låntager"),
...
SPAREBANKEN giver i første omgang Peter 5 måneders henstand med tilbagebetalingen, uden dog at give kautionisten besked. Herefter mister SPAREBANKEN tålmodigheden, og beder Peters ekskone om at indbetale de 250.000 kr. som hun har kautioneret for Peters lån.
...
```{r ,echo=FALSE, result=TRUE, fig.cap=("Parterne i en garantistillelse")}
