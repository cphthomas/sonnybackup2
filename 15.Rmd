...
```{r kaution, fig.height=3,echo=FALSE}
...
```{r network6, echo=FALSE, fig.height=4,result=TRUE,fig.cap=("Flere kautionister kan kautionere, enten som sam- eller medkautionister.")}
